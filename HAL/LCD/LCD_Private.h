...
/*
#define LCD_CTRL_RS		PB1
#define LCD_CTRL_RW		PB2
#define LCD_CTRL_EN		PB3
#define LCD_DATA_D4		PB4
#define LCD_DATA_D5		PB5
#define LCD_DATA_D6		PB6
#define LCD_DATA_D7		PB7
*/
#define LCD_CTRL_RS		PB1
#define LCD_CTRL_RW		PB2
#define LCD_CTRL_EN		PB3
